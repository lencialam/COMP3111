<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ClientManageClientInfo.aspx.cs" Inherits="HKeInvestWebApplication.ClientManageClientInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="FirstNameLabel" Text="First Name" CssClass="control-label col-md-2"></asp:Label>
                <asp:Label ID="FirstNameLabel" runat="server" CssClass="col-md-4"></asp:Label>
                <asp:Label runat="server" AssociatedControlID="LastNameLabel" Text="Last Name" CssClass="control-label col-md-2"></asp:Label>
                <asp:Label ID="LastNameLabel" runat="server" CssClass="col-md-4"></asp:Label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <asp:Label ID="Label14" runat="server" Text="Country of citizenship" CssClass="control-label col-md-2"></asp:Label>
                <asp:Label ID="CountryOfCitizenshipLabel" runat="server" CssClass="col-md-4"></asp:Label>
                <asp:Label ID="Label15" runat="server" Text="Country of legal residence" CssClass="control-label col-md-2"></asp:Label>
                <asp:Label ID="CountryOfResidenceLabel" runat="server" CssClass="col-md-4"></asp:Label>
            </div>
            <div class="form-group">
                <asp:Label runat="server" Text="HKID/Passport Number" CssClass="control-label col-md-2"></asp:Label>
                <asp:Label ID="HKIDLabel" runat="server" CssClass="col-md-4"></asp:Label>
                <div id="passportcountrydiv" runat="server">
                    <asp:Label runat="server" Text="Passport country of issue" CssClass="control-label col-md-2"></asp:Label>
                    <asp:Label ID="PassportCountryOfIssueLabel" runat="server" CssClass="col-md-4"></asp:Label>
                </div>
            </div>
        </div>
        ...
        <div runat="server" id="ClientinfoCClientDiv" class="form-horizontal">
            ...
            <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="CFirstNameLabel" Text="First Name" CssClass="control-label col-md-2"></asp:Label>
                <div class="col-md-4">
                    <asp:Label ID="CFirstNameLabel" runat="server"></asp:Label>
                </div>
                <asp:Label runat="server" AssociatedControlID="CLastNameLabel" Text="Last Name" CssClass="control-label col-md-2 "></asp:Label>
                <div class="col-md-4">
                    <asp:Label ID="CLastNameLabel" runat="server"></asp:Label>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <asp:Label ID="Label30" runat="server" AssociatedControlID="CCountryOfCitizenshipLabel" Text="Country of citizenship" CssClass="control-label col-md-2"></asp:Label>
                <div class="col-md-4">
                    <asp:Label ID="CCountryOfCitizenshipLabel" runat="server"></asp:Label>
                </div>
                <asp:Label ID="Label31" runat="server" AssociatedControlID="CCountryOfResidenceLabel" Text="Country of legal residence" CssClass="control-label col-md-2"></asp:Label>
                <div class="col-md-4">
                    <asp:Label ID="CCountryOfResidenceLabel" runat="server"></asp:Label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:Label ID="CHKIDLabel" runat="server"></asp:Label>
                </div>
                <div runat="server" id="cpassportcountrydiv">
                    <asp:Label ID="Label33" runat="server" AssociatedControlID="CPassportCountryOfIssueLabel" Text="Passport country of issue" CssClass="control-label col-md-2"></asp:Label>
                    <div class="col-md-4">
                        <asp:Label ID="CPassportCountryOfIssueLabel" runat="server"></asp:Label>
                    </div>
                </div>
            </div>
        </div>
