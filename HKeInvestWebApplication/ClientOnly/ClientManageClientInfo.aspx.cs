...
{
    public partial class ClientManageClientInfo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            username = Context.User.Identity.GetUserName().Trim();
            if (!IsPostBack)
            {
                ...
                if (isValid)
                {
                    sql = "select * from Client, Account where Client.accountNumber=Account.accountNumber AND Account.userName='" + username + "' AND IsPrimaryHolder = 'true'";
                    ...
                    //dateOfBirth = dtInformation.Rows[0]["dateOfBirth"].ToString().Trim();
                    ...
                    if (accountType != "individual")
                    {
                        ...
                        if (coisValid)
                        {
                            sql = "select * from Client, Account where Client.accountNumber=Account.accountNumber AND Account.userName='" + username + "' AND IsPrimaryHolder = 'false'";
                            ...
                            //codateOfBirth = dtCoInformation.Rows[0]["dateOfBirth"].ToString().Trim();
                    ...
                    CountryOfCitizenshipLabel.Text = countryOfCitizenship;
                    CountryOfResidenceLabel.Text = countryOfResidence;
                    PassportCountryOfIssueLabel.Text = passportCountry;
                    ...
                    if (accountType != "individual")
                    {
                        ...
                        CFirstNameLabel.Text = cofirstName;
                        CLastNameLabel.Text = colastName;
                        CCountryOfCitizenshipLabel.Text = cocountryOfCitizenship;
                        CCountryOfResidenceLabel.Text = cocountryOfResidence;
                        CPassportCountryOfIssueLabel.Text = copassportCountry;
        ...
        protected void Apply_Click(object sender, EventArgs e)
        {
            ...
            string sql = "";
            sql = "SELECT accountNumber, accountType FROM Account WHERE username = '" + username + "'";
            DataTable dtInformation = myHKeInvestData.getData(sql);
            string accountNumber = dtInformation.Rows[0]["accountNumber"].ToString().Trim();
            string accountType = dtInformation.Rows[0]["accountType"].ToString().Trim();

            if (Page.IsValid)
            {
                //Use SQL to create the account in the database
                string sourceoffund = (SourceOfFund.Items[3].Selected) ? myHKeInvestCode.checkAndAddApostrophe(DescribeOtherFund.Text.Trim()) : SourceOfFund.SelectedValue.Trim();
                ...
                sql = "UPDATE Account SET InvestmentObjective = '" + InvestmentObjective.SelectedValue.Trim() + "', InvestmentKnowledge = '"
                    ...
                    + InvestmentExperience.SelectedValue.Trim() + "',SourceOfFund = '" + myHKeInvestCode.checkAndAddApostrophe(sourceoffund) + "' WHERE accountNumber = '" + accountNumber + "'";
                ...
                if (accountType == "individual")
                {
                    string building = (string.IsNullOrEmpty(Building.Text.Trim())) ? "NULL" : "'" + myHKeInvestCode.checkAndAddApostrophe(Building.Text.Trim()) + "'";
                    ...
                    string specificoccupation = (EmploymentStatus.Items[0].Selected) ? "'" + myHKeInvestCode.checkAndAddApostrophe(SpecificOccupation.Text.Trim()) + "'" : "NULL";
                    string yearswithemployer = (EmploymentStatus.Items[0].Selected) ? "'" + YearsWithEmployer.Text.Trim() + "'" : "NULL";
                    string employername = (EmploymentStatus.Items[0].Selected) ? "'" + myHKeInvestCode.checkAndAddApostrophe(EmployerName.Text.Trim()) + "'" : "NULL";
                    string employerphone = (EmploymentStatus.Items[0].Selected) ? "'" + EmployerPhone.Text.Trim() + "'" : "NULL";
                    string natureofbusiness = (EmploymentStatus.Items[0].Selected) ? "'" + myHKeInvestCode.checkAndAddApostrophe(NatureOfBusiness.Text.Trim()) + "'" : "NULL";

                    trans = myHKeInvestData.beginTransaction();
                    sql = "UPDATE Client SET Email = '" + myHKeInvestCode.checkAndAddApostrophe(Email.Text.Trim()) + "', ClientTitle = '" + PClientTitle.SelectedItem.Value.Trim()
                        + "', HomePhone = " + homePhone + ", HomeFax = " + homeFax + ", BusinessPhone = " + busiPhone + ", MobilePhone = "
                        + mobile + ", Building = " + building + ", Street = '" + myHKeInvestCode.checkAndAddApostrophe(Street.Text.Trim()) 
                        + "', District = '" + myHKeInvestCode.checkAndAddApostrophe(District.Text.Trim())
                ...
                else
                {
                    ...
                    string cbuilding = (string.IsNullOrEmpty(CBuilding.Text.Trim())) ? "NULL" : "'" + myHKeInvestCode.checkAndAddApostrophe(CBuilding.Text.Trim()) + "'";
                    ...
                    //Check whether the Client is employed
                    string cspecificoccupation = (CEmploymentStatus.Items[0].Selected) ? "'" + myHKeInvestCode.checkAndAddApostrophe(CSpecificOccupation.Text.Trim()) + "'" : "NULL";
                    string cyearswithemployer = (CEmploymentStatus.Items[0].Selected) ? "'" + CYearsWithEmployer.Text.Trim() + "'" : "NULL";
                    string cemployername = (CEmploymentStatus.Items[0].Selected) ? "'" + myHKeInvestCode.checkAndAddApostrophe(CEmployerName.Text.Trim()) + "'" : "NULL";
                    string cemployerphone = (CEmploymentStatus.Items[0].Selected) ? "'" + CEmployerPhone.Text.Trim() + "'" : "NULL";
                    string cnatureofbusiness = (CEmploymentStatus.Items[0].Selected) ? "'" + myHKeInvestCode.checkAndAddApostrophe(CNatureOfBusiness.Text.Trim()) + "'" : "NULL";

                    trans = myHKeInvestData.beginTransaction();
                    sql = "UPDATE Client SET Email = '" + CEmail.Text.Trim() + "', ClientTitle = '" + CClientTitle.SelectedItem.Value.Trim()
                        + "', HomePhone = " + chomePhone + ",HomeFax = " + chomeFax + ", BusinessPhone = " + cbusiPhone + ", MobilePhone = "
                        + cmobile + ", Building = " + cbuilding + ", Street = '" + myHKeInvestCode.checkAndAddApostrophe(CStreet.Text.Trim())
                        + "', District = '" + myHKeInvestCode.checkAndAddApostrophe(CDistrict.Text.Trim())
                        ...
                        + cnatureofbusiness + ", HiredByFinancial = '" + CEmployedFinancialInstitution.SelectedValue.Trim() 
                        + "',PublicTradedCompany = '" + CDirectorOfTradedCompany.SelectedValue.Trim() + "', EmployerName = " + cemployername
