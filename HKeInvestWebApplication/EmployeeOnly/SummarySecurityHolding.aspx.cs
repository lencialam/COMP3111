...
{
    public partial class SummarySecurityHolding : System.Web.UI.Page
    {
        ...
        protected void Stock_Click(object sender, EventArgs e)
        {
            ...
            string ANinfo = lblAccountNumber.Text.ToString();
            Session["type"] = "stock";
            Session["Account_Number"] = ANinfo.Substring(ANinfo.Length-10);
            Response.Redirect("SecurityHoldingDetails.aspx");
        }
